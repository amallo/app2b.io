          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                Nous sommes deux ingénieurs spécialisés dans la conception de produits numériques, forts de plus de 15 ans d’expérience.
                Nos clients s'étendent de startups innovantes aux sociétés du CAC40.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                Notre capacité à concevoir des solutions parfaitement adaptées à vos attentes est la marque d'un accompagnement sans faille. Qu’il s’agisse de qualité (ce point est non négociable), de respect du budget ou de confidentialité, vous pouvez comptez sur notre expertise !
              </p>
